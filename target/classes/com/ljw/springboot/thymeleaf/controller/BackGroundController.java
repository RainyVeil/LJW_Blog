...
public class BackGroundController {
    ...
    public static final String localAddress = "/opt/static/pic" ;
    public static final String tempAddress = "/opt/temp/pic" ;
    ...
    /*图片管理*/
    @RequestMapping("/blog/picConfigPage")
    public String picConfigPage(Model model){
        HashMap data = new HashMap();
        ArrayList flist = blogFileService.queryAllPicture();
        model.addAttribute("files",flist);
        return "background/pictureconfig";
    }
    /*图片展示*/
    @ResponseBody
    @RequestMapping("/blog/setPicInfo")
    public Map picFrame(@RequestParam("id") int id){
        HashMap data = new HashMap();
        BlogFile bfile = new BlogFile();
        bfile.setId(id);
        data.put("picInfo",blogFileService.queryPictureByPrimaryKey(bfile).get(0));
    ...
    public Map imageUpload(HttpServletRequest request,@RequestParam("fileName") MultipartFile file){
        ...
        if (file.getSize() / 1000 > 1000){
            ...
            if (fileType.equals("image/jpeg") || fileType.equals("image/png") || fileType.equals("image/jpeg")) {
                ...
                final String localPath = tempAddress;
                ...
                if (FileUtils.upload(file, localPath, fileName)) {
                    ...
                    String relativePath="http://47.108.30.112/temppic/"+fileName;
...
//        JSON.toJSONString(root,SerializerFeature.DisableCircularReferenceDetect);
    ...
    public HashMap publish(HttpServletRequest request, HttpServletResponse response,
        ...
        map.put("localPath",localAddress);
