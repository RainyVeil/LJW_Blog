...
public class StudentController {
    ...
    public Object addStudent(Student student,HttpServletRequest request){
        request.getSession();
    ...
    public Object deleteStudent(Student student,@PathVariable("sId") int sId,HttpServletRequest request){
        student.setsId(sId);
